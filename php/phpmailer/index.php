        ...
        <div class="row">
            <div class="col-md-6 offset-md-3">
                ...
                <div class="card my-5">
                    ...
                    <form class="card-body cardbody-color p-lg-5" action="config/login.php" method="POST">
                        ...
                        <div class="alert alert-primary" role="alert">
                            ...
                            switch ($_GET['messsage']) {
                                case 'ok':
                                    ...
                                    break;
                                default:
                                    echo "Error al enviar el correo, por favor intenta de nuevo.";
                                    break;
                            }
                            ?>
                        </div>
